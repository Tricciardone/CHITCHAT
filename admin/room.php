		<div class="col-lg-12">
            <div class="panel panel-default" style="height:50px;">
				<span style="font-size:18px; margin-left:10px; position:relative; top:13px;"><strong>Sala de chat: <?php echo $chatrow['chat_name']; ?></strong></span>
				<div class="pull-right" style="margin-right:10px; margin-top:7px;">
					...
					<a href="#delete_room" data-toggle="modal" class="btn btn-danger">Borrar sala</a>
				...
				<div class="showme hidden" style="position: absolute; left:570px; top:20px;">
					<div class="well">
						<strong>Miembro de la sala/s:</strong>
			...
			<div>
				<div class="panel panel-default" style="height: 400px;">
					<div style="height:10px;"></div>
					<span style="margin-left:10px;">Bienvenido a la sala</span><br>
					<span style="font-size:10px; margin-left:10px;"><i>Nota: Evitar el uso de lenguaje inapropiado para no ser expulsado</i></span>
					<div style="height:10px;"></div>
