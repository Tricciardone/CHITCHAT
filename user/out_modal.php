        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    ...
                    <center><h4 class="modal-title" id="myModalLabel">Abandonar sala...</h4></center>
                </div>
                ...
                <div class="modal-footer">
                    ...
                    <button type="submit" class="btn btn-warning" id="confirm_leave2"><span class="glyphicon glyphicon-check"></span> Salir</button>
    ...
    <div class="modal fade" id="delete_room2" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    <button type="button" class="btn btn-default" data-dismiss="modal"><span class="glyphicon glyphicon-remove"></span> Cancelar</button>
                    <button type="submit" class="btn btn-danger" id="confirm_delete2"><span class="glyphicon glyphicon-check"></span> Borrar</button>
						...
						<select style="width:350px;" class="form-control" name="user">
							...
							include('../conn.php');
								...
								if(mysqli_num_rows($u)<1){
									?>
									<option value="">El usuario no está disponible.</option>
									<?php
								}
								else{
